...
# This is the MLX90614 library that helps provide the temperature reading
# The clas MLX  is used to help read the data from the bus and output the object/ambient temp.
class MLX90614():
